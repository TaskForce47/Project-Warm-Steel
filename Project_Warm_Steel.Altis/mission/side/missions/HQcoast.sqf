...
//------------------------------------------- SPAWN OBJECTIVE AND AMBIENCE 
	...
	boat setDir random 360;
		"rhs_g_Soldier_F3" createUnit [_boatPos,_smuggleGroup]; "rhs_g_Soldier_F3" createUnit [_boatPos,_smuggleGroup]; "rhs_g_Soldier_F3" createUnit [_boatPos,_smuggleGroup]; "rhs_g_Soldier_F3" createUnit [_boatPos,_smuggleGroup]; "rhs_g_Soldier_F3" createUnit [_boatPos,_smuggleGroup];
