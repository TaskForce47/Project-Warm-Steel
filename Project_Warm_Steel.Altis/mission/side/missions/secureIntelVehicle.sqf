...
#define OBJVEH_TYPES "UAZ_Unarmed","rhs_uaz_open_chdkz","RHS_UAZ_chdkz","rhs_ural_work_open_chdkz","rhs_ural_open_chdkz","rhs_ural_work_chdkz","rhs_ural_chdkz"
#define OBJUNIT_TYPES "rhs_g_Soldier_TL_F","rhs_g_Soldier_SL_F"
...
//-------------------------------------------------------------------------- CREATE GROUP, VEHICLE AND UNIT
	...
	"rhs_g_Soldier_SL_F" createUnit [_flatPos1, _aGroup];
	...
	"rhs_g_Soldier_SL_F" createUnit [_flatPos1, _bGroup];
	...
	"rhs_g_Soldier_SL_F" createUnit [_flatPos2, _cGroup];
