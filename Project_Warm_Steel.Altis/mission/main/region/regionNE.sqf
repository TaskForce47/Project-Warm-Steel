...
_targets = ["Sofia Radar Station","Research Facility","Limni","Paros","Molos","Delfinaki Outpost","Delfinaki","Nidasos Woodlands","Sofia Powerplant","Gatolia Solar Farm","Molos Airfirld","Ghost Hotel","Kalithea","Kalochori","Ochrolimni","Almyra"];
