...
#define INF_TYPE "LOP_ChDKZ_AT_section","LOP_ChDKZ_Patrol_section","LOP_ChDKZ_Rifle_squad","LOP_ChDKZ_Support_section","LOP_ChDKZ_Rifle_squad","LOP_ChDKZ_Patrol_section",
#define INF_URBANTYPE "LOP_ChDKZ_Patrol_section","LOP_ChDKZ_Rifle_squad"
#define MRAP_TYPE "LOP_ChDKZ_BM21","LOP_ChDKZ_UAZ","LOP_ChDKZ_UAZ_Open","LOP_ChDKZ_Ural","LOP_ChDKZ_Ural_open"
#define VEH_TYPE "LOP_ChDKZ_BMP1","LOP_ChDKZ_BMP1D","LOP_ChDKZ_BMP2","LOP_ChDKZ_BMP2D","LOP_ChDKZ_BTR60","LOP_ChDKZ_BTR70","LOP_ChDKZ_BTR70","LOP_ChDKZ_BTR70"
#define AIR_TYPE "LOP_ChDKZ_Mi8MT_Cargo","LOP_ChDKZ_Mi8MT_Cargo","LOP_ChDKZ_Mi8MTV3_FAB","LOP_ChDKZ_Mi8MTV3_UPK23"
#define STATIC_TYPE "LOP_ChDKZ_NSV_TriPod"
...
for "_x" from 1 to PARAMS_AAPatrol do {
	...
	_aa = "LOP_ChDKZ_ZSU234" createVehicle _randomPos;
	waitUntil{!isNull _aa};
	_aa allowCrewInImmobile true;
		"LOP_ChDKZ_Infantry_Engineer" createUnit [_randomPos,_aaGroup];
		"LOP_ChDKZ_Infantry_Engineer" createUnit [_randomPos,_aaGroup];
		"LOP_ChDKZ_Infantry_Engineer" createUnit [_randomPos,_aaGroup];
...
for "_x" from 1 to PARAMS_StaticMG do {
	...
	_static setDir random 360;
		"LOP_ChDKZ_NSV_TriPod" createUnit [_randomPos,_staticGroup];
...
for "_x" from 0 to (3 + (random 2)) do {
	...
	if (random 1 >= 0.25) then {
		...
		"LOP_ChDKZ_Infantry_Engineer" createUnit [_randomPos,_AOvehGroup];
		"LOP_ChDKZ_Infantry_Engineer" createUnit [_randomPos,_AOvehGroup];
		"LOP_ChDKZ_Infantry_Engineer" createUnit [_randomPos,_AOvehGroup];
...
if((random 10 <= PARAMS_AirPatrol)) then {
	...
	_air spawn
	{
		...
		"LOP_ChDKZ_Infantry_Pilot" createUnit [_randomPos,_airGroup];
...
for "_x" from 1 to PARAMS_SniperTeamsPatrol do {
	...
	_sniperGroup = [_randomPos, EAST,(configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "UInfantry" >> "LOP_ChDKZ_Patrol_section")] call BIS_fnc_spawnGroup;
