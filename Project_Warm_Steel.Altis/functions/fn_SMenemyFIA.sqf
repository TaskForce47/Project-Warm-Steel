...
for "_x" from 0 to 2 do {
	...
	_IRGsniperGroup = [_randomPos, EAST, (configfile >> "CfgGroups" >> "Indep" >> "rhs_faction_insurgents" >> "Infantry" >> "IRG_SniperTeam_M")] call BIS_fnc_spawnGroup;
...
for "_x" from 0 to 3 do {
	...
	_randomPos = [[[getPos sideObj, 300],[]],["water","out"]] call BIS_fnc_randomPos;
	_SMveh = "UAZ_AGS30" createVehicle _randomPos;
	waitUntil{!isNull _SMveh};

		"rhs_g_Soldier_F3" createUnit [_randomPos,_SMvehPatrol];
		"rhs_g_Soldier_F3" createUnit [_randomPos,_SMvehPatrol];
		"rhs_g_Soldier_F3" createUnit [_randomPos,_SMvehPatrol];
