...
for "_x" from 0 to 1 do {
	...
	_indSniperTeam = [_randomPos, EAST, (configfile >> "CfgGroups" >> "Indep" >> "rhs_faction_insurgents" >> "Infantry" >> "IRG_SniperTeam_M")] call BIS_fnc_spawnGroup;
...
waitUntil {sleep 0.5; !isNull _SMveh};
	"rhs_g_engineer_F" createUnit [_randomPos,_SMvehPatrol];
	"rhs_g_engineer_F" createUnit [_randomPos,_SMvehPatrol];
	"rhs_g_engineer_F" createUnit [_randomPos,_SMvehPatrol];
