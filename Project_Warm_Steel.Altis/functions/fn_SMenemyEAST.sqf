...
for "_x" from 0 to 1 do {
	...
	_smSniperTeam = [_randomPos, EAST, (configfile >> "CfgGroups" >> "Indep" >> "rhs_faction_insurgents" >> "Infantry" >> "IRG_SniperTeam_M")] call BIS_fnc_spawnGroup;
...
if(typeOf _SMveh1 == "UAZ_AGS30" || typeOf _SMveh1 == "UAZ_SPG9" || typeOf _SMveh1 == "UAZ_MG") then {
...
if(typeOf _SMveh2 == "UAZ_AGS30" || typeOf _SMveh2 == "UAZ_SPG9" || typeOf _SMveh2 == "UAZ_MG") then {
	_helperGroup = createGroup east;
	"rhs_g_engineer_F" createUnit [_randomPos, _helperGroup];
	"rhs_g_engineer_F" createUnit [_randomPos, _helperGroup];
